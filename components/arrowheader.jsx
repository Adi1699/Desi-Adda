...
const arrowheader = (props) => {
    return (
        <View style={styles.container}>
            <View>
                {
                    props.context ? <View style={styles.iconHolder}><Icon name="arrow-left" size={0} color={appstyles.fontColorInactive}/><Text style={[styles.headTxtsc,{marginLeft: 20}]}>{props.headTxt}</Text></View> : <Text style={styles.headTxt}>{props.headTxt}</Text>  
                }
            </View>
                {
                    (!props.context) ?      
